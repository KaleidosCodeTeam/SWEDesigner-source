/**
 * Created by socs on 05/06/2017.
 */
$("#panel-zero").css("display","inline");

$(".testbutton-panel").click(function(){
    $(".panel-swedesigner").css("display","none")
});

$("#showpanel-zero").click(function(){
    $("#panel-zero").css("display","inline")
});

$("#showpanel-link").click(function(){
    $("#panel-link").css("display","inline")
});

$("#showpanel-comment").click(function(){
    $("#panel-comment").css("display","inline")
});
